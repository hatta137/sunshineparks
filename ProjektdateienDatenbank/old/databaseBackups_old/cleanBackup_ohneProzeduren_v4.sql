...
--
-- Host: localhost
-- Erstellungszeit: 11. Jul 2022 um 20:46
...
INSERT INTO `MAINTENANCE` (`MaintenanceID`, `RentalID`, `Description`, `MaintenanceDate`, `RepairProtocol`, `EmpID`) VALUES
(1, 12, 'Stuhl kaputt', '2022-04-12', 'Stuhlbein ausgetauscht', 13),
(2, 24, 'Toilette spült nicht', '2022-06-15', 'Spülung repariert', 15),
(3, 8, 'TV geht nicht mehr an', '2022-06-15', 'Neuen TV installiert', 10),
(4, 2, 'Fenster lässt sich nicht mehr kippen', '2020-05-25', 'Fenstergriff ausgetauscht', 11),
(5, 18, 'Rechte Bettlampe ghet nicht an', '2021-02-03', 'Glühbirne gewechselt', 14);
